 ...
 */
public final class OracleUndoLogManager extends AbstractUndoLogManager {
    ...
    private static String INSERT_UNDO_LOG_SQL = "INSERT INTO " + UNDO_LOG_TABLE_NAME + "\n" +
        ...
        "VALUES (seq_undo_log_id.nextval, ?, ?, ?, 0, current_date, current_date)";

    private static class OracleUndoLogManagerHolder {
        private static OracleUndoLogManager instance = new OracleUndoLogManager();
    }

    private OracleUndoLogManager() {

    }

    public static OracleUndoLogManager instance() {
        return OracleUndoLogManagerHolder.instance;
    }
